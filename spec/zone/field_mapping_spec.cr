...
describe Zone::FieldMapping do
  describe ".from_fields" do
    it "creates mapping from field names" do
  ...
  describe "[]" do
    it "aliases resolve for field names" do
  ...
  describe "error handling" do
    ...
    pending "raises error for invalid key type" do
      # Crystal's type system prevents invalid types at compile time
      # This test cannot be written in Crystal as it would fail compilation
    end
  end
  ...
  describe "#names" do
    ...
    it "returns empty for numeric mapping" do
      mapping = Zone::FieldMapping.numeric
